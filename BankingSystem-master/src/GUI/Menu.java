...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		contentPane.setForeground(SystemColor.CYAN);
		...
		lblBankingSystem.setBounds(0, 79, 613, 59);
...
//		contentPane.add(btnAddAccount);
		...
		btnWithdrawFromAccount.setBounds(217, 216, 194, 33);
		...
		btnDepositToAccount.setBounds(217, 253, 194, 33);
		contentPane.add(btnDepositToAccount);
